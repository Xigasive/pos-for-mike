...
const regex = /\{restockMasterItemId \? \([\s\S]*?\{\!restockMasterItemId && \(\s*<label className="flex flex-col text-sm font-semibold text-slate-500">\s*วิธีการชำระเงิน[\s\S]*?<\/label>\s*\)\}/s;
